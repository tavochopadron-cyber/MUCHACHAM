...
def asignar_area(respuestas):
    ...
    for area, indices in AREAS.items():
        conteo[area] = sum(1 for i in indices if respuestas[i] == "Sí")
...
def realizar_cuestionario(preguntas, tipo):
    ...
    for i, p in enumerate(preguntas):
        while True:
            ...
            if r in ("S", "N"):
                respuestas.append("Sí" if r == "S" else "No")
                if r == "S":
                    puntaje += 1
                break
...
def iniciar_proceso_seleccion():
    ...
    pt_tecnico, resp_tecnicas = realizar_cuestionario(PREGUNTAS_TECNICAS, "TÉCNICAS")
